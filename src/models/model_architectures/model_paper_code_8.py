...
def create_paper_code_8_model(dropout_rate=0.5):
    ...
    spec_cnn = tf.keras.layers.Conv2D(filters=64, kernel_size=(2, 16), padding="same")(spec_cnn)
    spec_cnn = tf.keras.layers.Activation('relu')(spec_cnn)
    spec_cnn = tf.keras.layers.BatchNormalization()(spec_cnn)
    ...
    spec_cnn = tf.keras.layers.Conv2D(filters=128, kernel_size=(2, 32), padding="same")(spec_cnn)
    ...
    spec_cnn = tf.keras.layers.Conv2D(filters=128, kernel_size=(1, 2), padding="same")(spec_cnn)
    spec_cnn = tf.keras.layers.Activation("relu")(spec_cnn)
    spec_cnn = tf.keras.layers.BatchNormalization()(spec_cnn)

    spec_cnn = tf.keras.layers.Conv2D(filters=128, kernel_size=(3, 16), padding="same")(spec_cnn)
    spec_cnn = tf.keras.layers.MaxPooling2D(pool_size=(1, 4), padding="same")(spec_cnn)
    spec_cnn = tf.keras.layers.Activation("relu")(spec_cnn)
    spec_cnn = tf.keras.layers.BatchNormalization()(spec_cnn)
