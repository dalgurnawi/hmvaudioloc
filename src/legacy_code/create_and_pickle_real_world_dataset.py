...
def map_dataset():
    list_of_all_files = glob.glob('real_world_level/*/*.wav')
...
dataset.shuffle(len(glob.glob('real_world_level/*/*.wav')))
print("create and shuffle")

tf.data.experimental.save(dataset, "pickled_real_world_dataset.dat")
